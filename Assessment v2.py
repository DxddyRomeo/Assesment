...
while not playagain:
    ...
    if difficulty == "H":
        numbers = [["Tekau mā Tahi", 11], ["Tekau mā Rua", 12],
                   ["Tekau mā Toru", 13], ["Tekau mā Wha", 14],
                   ["Tekau mā Rima", 15], ["Tekau mā Ono", 16],
                   ["Tekau mā Whitu", 17], ["Tekau mā Waru", 18],
                   ["Tekau mā Iwa", 19], ["Rua Tekau", 20]]
        random.shuffle(numbers)
    else:
        numbers = [["Tahi", 1], ["Rua", 2], ["Toru", 3], ["Wha", 4],
                   ["Rima", 5],
    ...
    for i in numbers:
        answer = int(
        input(f"Please Enter the Following Number In English ,  {i[0]}:"))
    if answer == i[1]:
        print("###### CORRECT! ######\n")
        score = score + 1
        print("Your Current Score Is", score)
        ...
        score = score - 1
        print("Your Current Score Is", score)
    playagain = input("Press Enter to Play again or any other key to exit: ")
